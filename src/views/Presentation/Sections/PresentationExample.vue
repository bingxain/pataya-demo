      ...
      <div class="row">
        <div class="row justify-content-center text-center my-sm-5">
          <div class="col-lg-6">
            ...
            <h2 class="text-dark mb-0">Huge collection of Information</h2>
            <p class="lead">
              Our exclusive services and in-depth information definately make your trip in
              Pattya more entertained.
            </p>
          </div>
        </div>
      </div>
