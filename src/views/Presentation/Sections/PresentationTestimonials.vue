...
const viewedCount = () => {
  let basicCount = 170000000;
  let basicUnit = 10000;
  return String(Math.floor(Date.now() / basicUnit) - basicCount).replace(
    /(\d)(?=(\d{3})+$)/g,
    "$1,"
  );
};
      ...
      <div class="row">
        <div class="col-lg-6 mx-auto text-center">
          ...
          <h2 class="text-gradient text-success mb-3">
            {{ viewedCount() }} Travelers viewed
          </h2>
          <p class="lead">
            Many Fortune 500 companies, store, travel agency and governmental
            institutions love our products.
          </p>
        </div>
      </div>
      <div class="row mt-6">
...
//   data() {
//     return {
//       viewedCount: this.getViewedCount(),
//     };
//   },
//   methods: {
//     getViewedCount() {
